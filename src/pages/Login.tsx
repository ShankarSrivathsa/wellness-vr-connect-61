        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2">
              <AnimatedGradientText>Welcome to Serapisuto</AnimatedGradientText>
            </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/forgot-password" className="text-sm text-wellness-600 hover:text-wellness-800">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="relative">
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <div className="text-center mt-4">
                <p className="text-sm text-gray-600">
                  ...
                  <Link to="/register" className="text-wellness-600 hover:text-wellness-800 font-medium">
                    Sign up
                  </Link>
                </p>
              </div>
